...
{ 
	//---=== modFriendlyHUD ===---
	public			var fHUDConfig						: CModFriendlyHUDConfig;
	public saved	var newCraftables					: array<name>;
	//---=== modFriendlyHUD ===---
	...
	event OnSpawned( spawnData : SEntitySpawnData )
	{
		...
		//---=== modFriendlyHUD ===---
		fHUDConfig = new CModFriendlyHUDConfig in this;
		fHUDConfig.Init();
		//---=== modFriendlyHUD ===---
	...
	//---=== modFriendlyHUD ===---
	timer function PinEssentialGroupTimer( deltaTime : float, id : int )
	{
		ToggleEssentialModules( !IsHUDGroupEnabledForReason( GetFHUDConfig().essentialModules, "PinEssentialGroup" ), "PinEssentialGroup" );
	}
	
	timer function EssentialsOnTimer( deltaTime : float, id : int )
	{
		ToggleEssentialModules( true, "EssentialModulesHotkey" );
	}
	
	timer function MapOnTimer( deltaTime : float, id : int )
	{
		ToggleMinimapModules( true, "MinimapModulesHotkey" );
	}
	
	timer function QuestsOnTimer( deltaTime : float, id : int )
	{
		ToggleQuestsModules( true, "QuestsModulesHotkey" );
	}
	
	timer function CharOnTimer( deltaTime : float, id : int )
	{
		ToggleCharacterModules( true, "CharModulesHotkey" );
	}
	
	timer function DamageOffTimer( deltaTime : float, id : int ) //still needed as workaround
	{
		ToggleHUDModule( "WolfHeadModule", false, "OnDamage" );
	}
	
	timer function MeditationModulesOnTimer( deltaTime : float, id : int ) //needed for compatibility
	{
	...
	timer function MeditationModulesOffTimer( deltaTime : float, id : int ) //needed for compatibility
	{
		if ( GetFHUDConfig().enableMeditationModules )
		{
	...
	event OnCombatStart()
	{
		...
		//---=== modFriendlyHUD ===---
		if ( GetFHUDConfig().enableCombatModules )
		{
			ToggleCombatModules( true, "InCombat" );
		}
		//---=== modFriendlyHUD ===---
