...
class CR4IngameMenu extends CR4MenuBase
{
	...
	protected function SaveChangedSettings()
	{
		if (hasChangedOption)
		{
			...
			//---=== modFriendlyHUD ===---
			GetFHUDConfig().UpdateUserSettings();
			//---=== modFriendlyHUD ===---
		}
	}
	...
	protected function GetKeybindGroupTag(keybindName : name) : name
	{
		...
		//---=== modFriendlyHUD ===---
		else if (mInGameConfigWrapper.DoVarHasTag('PCInput', keybindName, 'input_overlap_fhud1')
					|| keybindName == 'HoldToSeeEssentials' || keybindName == 'HubMenu')
		{
			return 'input_overlap_fhud1';
		}
		else if (mInGameConfigWrapper.DoVarHasTag('PCInput', keybindName, 'input_overlap_fhud2')
					|| keybindName == 'HoldToSeeCharStats' || keybindName == 'PanelChar')
		{
			return 'input_overlap_fhud2';
		}
		else if (mInGameConfigWrapper.DoVarHasTag('PCInput', keybindName, 'input_overlap_fhud3')
					|| keybindName == 'HoldToSeeMap' || keybindName == 'PanelMap')
		{
			return 'input_overlap_fhud3';
		}
		else if (mInGameConfigWrapper.DoVarHasTag('PCInput', keybindName, 'input_overlap_fhud4')
					|| keybindName == 'HoldToSeeQuests' || keybindName == 'PanelJour')
		{
			return 'input_overlap_fhud4';
		}
		//---=== modFriendlyHUD ===---
